...
Org syntax is translated through org-ruby to pre tag. Here, org and HTML are very equivalent, except for one disadvantage shown below.
...
Example:
#+HTML:<pre>#+BEGIN_SRC<br>Some code<br>More code#+END_SRC</pre>
...
Example:
#+HTML:<pre>#+HTML:&lt;pre&gt;Some HTML or org-syntax: #+BEGIN_SRC&lt;/pre&gt;<br>#+BEGIN_HTML<br>&lt;pre&gt;<br>Some HTML<br>&lt;/pre&gt;<br>#+END_HTML</pre>
...
Disadvantages:
- Not easy to use.
- To Write HTML inside an HTML code block, you must replace the tag brackets (< >) with &lt; and &gt; (&lt;a tag element&gt;).
