...
That's where these hacks come in, primarily using HTML, to get around these limitations as well as to show some additional formatting customizations and preferences.
